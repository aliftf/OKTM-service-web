        ...
        <div class="px-5 mx-5">
            ...
            <div class="border border-secondary-subtle rounded-5 pb-3 mb-5 shadow bg-body-tertiary rounded">
                ...
                <div class="pt-5 pb-2 px-5 mx-5">
                    ...
                    <ul>
                        <li class="mb-2">Terdaftar sebagai mahasiswa yang masih menempuh pendidikan di Telkom University.</li>
            ...
            <div class="border border-secondary-subtle rounded-5 mb-5 shadow bg-body-tertiary rounded">
                ...
                <div class="py-3">
                    <div class="mx-5 ps-5 pt-5 row">
                        <div class="col-3 text-left fs-6 fw-bold">
                            Nama Mahasiswa
                        </div>
                        <div class="col-3 text-left fs-6">
                            REGY RENANDA RAHMAN
                        </div>
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row px-5 mx-5">
                            ...
                            <div class="w-75 row d-flex justify-content-between align-items-center mb-3 me-2">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" readonly class="form-control-plaintext" id="tahun_ajar"
                                        value="2021">
                                </div>
                            </div>
                        ...
                        <div class="col-12 text-center my-5">
                            <button type="submit" class="btn filing-form-btn-color px-5 fw-bold border border-danger">Submit</button>
                        </div>
                    </form>
                </div>
            </div>
