...
<div class="d-flex flex-column justify-content-center align-items-center mt-5 mb-5" style="height:auto;">
    {{-- Informasi --}}
    <div class="d-flex flex-column justify-content-center align-items-center mb-5" style="width:auto;">
        {{-- Judul --}}
        ...
        <div class="container">
            {{-- Header --}}
            <div class="d-lg-flex flex-row shadow-lg p-3 rounded rounded-bottom-0 text-white" style="background-color: #9D0000;">
    ...
    <div class="d-flex flex-column justify-content-center align-items-center mt-5 mb-5" style="width:auto;">
        {{-- Judul --}}
        <div class="d-flex flex-wrap">
            <h2 class="text-center m-2" style="font-weight:bold;">Pengajuan Penggantian KTM Baru |</h2>
